...
tbl_x_mb_adj <- merge(tbl_x_mb, tbl_x_ste_ratio, by = "STE_CODE11", allow.cartesian=TRUE)
setnames(tbl_x_mb_adj, "value", "raw")
tbl_x_mb_adj <- tbl_x_mb_adj[, value_adj := (raw*apr_mean_ratio_15.19)]
...
saveRDS(tbl_x_mb_adj, "working_temporary/no2_lur/tbl_no2_sat_mb_lng.rds")
}
